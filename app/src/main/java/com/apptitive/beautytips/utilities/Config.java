 ...
 */
public class Config {
    private static final String MENU_URL = "http://apptitive.com/beauty_tips/json/menu.json";
    private static final String TOPIC_URL = "http://apptitive.com/beauty_tips/json/content.json";
