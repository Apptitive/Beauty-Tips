...
import com.apptitive.beautytips.receiver.NotificationCancelReceiver;
...
public class Utilities {
    ...
    public static SpannableString[] getBanglaSpannableStrings(String[] banglaRegionNames, Context context) {
        SpannableString[] banglaText = new SpannableString[banglaRegionNames.length];
